...
async function main() {
  ...
  if (!relayerHasManageHistory) {
    ...
    console.log("\n✅ live-event-history-manager-arbitrum-sepolia PASSED (read-only coverage)\n");
    return;
  }
  ...
  console.log("\n✅ live-event-history-manager-arbitrum-sepolia PASSED\n");
}

void runWithNetworkRetry("live-event-history-manager-arbitrum-sepolia", main);