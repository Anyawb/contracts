...
contract MockVaultCoreForSettlementManager {
    ...
    function repayViaSettlementManager(
        ...
        IERC20(debtAsset).safeTransferFrom(msg.sender, settlementManager, amount);
        ISettlementManager(settlementManager).repayAndSettle(msg.sender, debtAsset, amount, orderId);
    }
}
