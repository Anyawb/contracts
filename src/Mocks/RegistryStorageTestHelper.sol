...
/// @notice Helper contract to write RegistryStorage via delegatecall.
/// @dev Deploy this contract and call its methods via delegatecall from Registry's address.
contract RegistryStorageTestHelper {
